 ...
 */
@Service
public class AnnotationTransactionPropagateNeverServiceImpl implements IAnnotationTransactionPropagateNeverService {

    @Autowired
    private UserMapper userMapper;

    @Autowired
    private IAnnotationTransactionPropagateNeverService neverService;
    ...
    public void openTransaction(int method) throws Exception {
        if (1 == method) {
            neverService.firstWayIsAHaveTransaction();
        } else if (2 == method) {
            neverService.secondWayIsAHaveTransaction();
        }
    }
    ...
    public void firstWayIsAHaveTransaction() throws Exception {
         ...
         * B
         */
        neverService.firstWayIsBNoHaveTransaction();
    }
    ...
    public void secondWayIsAHaveTransaction() throws Exception {
         ...
         * B
         */
        neverService.secondWayIsBNoHaveTransaction();
    ...
    public void threeWayIsAHaveTransaction() throws Exception {
         ...
         * B
         */
        neverService.threeWayIsBNoHaveTransaction();
